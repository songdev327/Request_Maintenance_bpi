...
function ListFormProduct() {
  ...
  // const requestCount = requestList.filter(item => item.request_status === "request").length;
  ...
  const handleMachineClick = (item) => {
    navigate("/resultFormPro", { state: { machineData: item } });
  };
        ...
        <div className="col-md-6" >
          <div className="m-1 rounded p-1" id="board-product">
            <div className="row align-items-end">
              ...
              <div className="col-sm-3 col-md-3 mb-2 ml-4">
...
export default ListFormProduct;
