...
function ResultFormProToMMSetting() {
    ...
    const handleUpdate_request_to_pro = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                `${config.api_path}/Maintenance/updateRequestToProSetting/${formData.id}`,
                payload
            );
    ...
    return (
        <>
            <div className="mr-root">
                ...
                <div className='text-danger fw-bold'> ( ADMIN PAGE )</div>
                <div className="mr-a4">
                    ...
                    <div className="mr-row mr-meta mr-between">
                        ...
                        <div className="mr-col-12 text-primary">
                            ถึง (To): <strong>{formData.to}</strong>
                            ...
                            <div class="form-group">
                                <div class="field-label">SHIFT :
                                    <input
                                        ...
                                        onChange={(e) => setField("shift", e.target.value.toUpperCase())}
                                    /></div>
                            ...
                            <div class="form-group">
                                <div class="field-label">MACHINE STOP TIME :
                                    <input
                                        type="text"
                                        class="dotted-input text-primary"
                                        value={formData.machine_stop_time}
                            ...
                            <div class="form-group">
                                <div class="field-label"><span style={{ color: "rgba(1, 5, 255, 1)" }}>LOCATION :</span>
                                    <input
                                        ...
                                        checked={formData.Location_Name === "BPI"}
                                    ...
                                    <input
                                        ...
                                        checked={formData.Location_Name === "BPI TO NVK"}
                                    ...
                                    <input
                                        type="radio"
                                        name="Location_Name" className="ml-5"
                                        checked={formData.Location_Name === "NVK"}
                            ...
                            <div className="status-options">
                                ...
                                <label>
                                    <input
                                        type="radio"
                                        name="machine_status"
                                        checked={formData.machine_status === "can_running"}
                                ...
                                <label>
                                    <input
                                        type="radio"
                                        name="machine_status"
                                        checked={formData.machine_status === "cannot_running_stop"}
                                ...
                                <label>
                                    <input
                                        type="radio"
                                        name="machine_status"
                                        checked={formData.machine_status === "no_schedule"}
                        ...
                        <div className="mr-row">
                            <div className="mr-col-24 mr-line-wrap">
                                <textarea
                                    ...
                                    onChange={(e) => setField("brief_description", e.target.value.toUpperCase())}
                                />
                            </div>
                            <div className="mr-col-24 mr-line-wrap">
                                <textarea
                                    ...
                                    col={12}
                                    rows={2}
                                    value={formData.production_action || ""}
                                    className="mr-box dotted text-primary"
                                    onChange={(e) => setField("production_action", e.target.value.toUpperCase())}
                                />
                            </div>
                        </div>
                    </section>
                                    ...
                                    <div className="mr-col-24 mr-line-wrap">
                                        <div className="autocomplete mb-1">
                                            <input
                                                ...
                                                onChange={(e) => { setCorrectiveQuery(e.target.value); setOpenCorrective(true); setHiIdx(-1); }}
...
export default ResultFormProToMMSetting;
